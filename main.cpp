...
// REQURIES: valid ints and string. String must be lower case.
// MODIFIES: Nothing.
...
void gatherUserInput()
{
	...
	// Forcing string to lower case to test value
	transform(strBeforeAfter.begin(), strBeforeAfter.end(), strBeforeAfter.begin(), ::tolower);
	
	// Testing user input
	while ( (strBeforeAfter != "before") && (strBeforeAfter != "after") )
	{
	...
	cout << "";
	cout << "========================================================================================" << endl;
	cout << "The date " << intTotalDays << " days " << strBeforeAfter << " " << findMonthString(intKnownMonth) << " " << intKnownDay << ", " << intKnownYear << " is: ";
